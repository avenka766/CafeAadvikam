  ...
  switch (role) {
    ...
    case 'branch_vrsnb':
      return [
        ...
        { label: 'Quotation', path: '/branch/vrsnb?tab=quotation', icon: <FileText className="size-4" />, group: 'Main' },
        { label: 'Returns', path: '/branch/vrsnb?tab=returns', icon: <Trash2 className="size-4" />, group: 'Operations' },
        { label: 'Store Orders', path: '/branch/vrsnb?tab=store-orders', icon: <Store className="size-4" />, group: 'Operations' },
        ...
        { label: 'Alerts', path: '/branch/vrsnb?tab=alerts', icon: <Bell className="size-4" />, group: 'Reports' },
      ];
    case 'branch_snb':
      return [
        ...
        { label: 'Store Orders', path: '/branch/snb?tab=store-orders', icon: <Store className="size-4" />, group: 'Operations' },
    ...
    case 'admin_vrsnb':
      return [
        ...
        { label: 'Stock Synced', path: '/admin-vrsnb?tab=stock-synced', icon: <PackageCheck className="size-4" />, group: 'Operations' },
        { label: 'Update Stock', path: '/admin-vrsnb?tab=update-stock', icon: <Settings2 className="size-4" />, group: 'Operations' },
        { label: 'Suppliers', path: '/admin-vrsnb?tab=suppliers', icon: <Truck className="size-4" />, group: 'Operations' },
        ...
        { label: 'Purchase Invoices', path: '/admin-vrsnb?tab=invoices', icon: <ShoppingCart className="size-4" />, group: 'Operations' },
        { label: 'Purchase Returns', path: '/admin-vrsnb?tab=purchase-returns', icon: <RotateCcw className="size-4" />, group: 'Operations' },
        { label: 'Supplier Payments', path: '/admin-vrsnb?tab=payments', icon: <WalletCards className="size-4" />, group: 'Operations' },
        { label: 'Bank Deposits', path: '/admin-vrsnb?tab=bank', icon: <ShieldCheck className="size-4" />, group: 'Operations' },
        { label: 'Current Cash', path: '/admin-vrsnb?tab=current-cash', icon: <WalletCards className="size-4" />, group: 'Reports' },
        { label: 'Salesperson Management', path: '/admin-vrsnb?tab=salespersons', icon: <Users className="size-4" />, group: 'Admin' },
        { label: 'Salesperson Report', path: '/admin-vrsnb?tab=salesperson-report', icon: <BarChart3 className="size-4" />, group: 'Reports' },
        ...
        { label: 'History', path: '/admin-vrsnb?tab=history', icon: <History className="size-4" />, group: 'Reports' },
    ...
    case 'admin_snb':
      return [
        ...
        { label: 'Stock Synced', path: '/admin-snb?tab=stock-synced', icon: <PackageCheck className="size-4" />, group: 'Operations' },
