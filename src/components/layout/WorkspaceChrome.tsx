  ...
  switch (role) {
    ...
    case 'planner':
      return [
        ...
        // "Custom Dispatch" used to be a separate top-level sidebar link. Per
        // explicit correction (2026-08-09): it belongs as a sub-tab inside
        // Dispatch itself, next to the Hosur branch button — see the
    ...
    case 'receiver_vrsnb':
      return [
        ...
        { label: 'Advance Orders', path: '/bakery/receive/vrsnb?tab=advance', icon: <ClipboardList className="size-4" />, group: 'Sales' },
