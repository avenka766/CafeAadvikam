...
export default function BottomNav() {
  ...
  // SNB and VRSNB branch billing both have their own in-page tab strip
  // (Bill/Advance/Returns/History/Payment/Closure/Alerts) in the billing top
  // bar now, so the floating bottom nav is redundant/duplicate navigation on
  // both — previously only SNB was hidden here, leaving VRSNB with two
  // overlapping navigation systems on screen at once.
  if (currentUser.role === 'branch_snb' || currentUser.role === 'branch_vrsnb') return null;
