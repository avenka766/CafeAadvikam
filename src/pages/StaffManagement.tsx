...
const ROLE_COLORS: Record<UserRole, string> = {
  ...
  sweet_master:    'bg-pink-100 text-pink-800',
  savouries_master:'bg-lime-100 text-lime-800',
  cookies_master:  'bg-yellow-100 text-yellow-800',
  puffs_master:    'bg-orange-100 text-orange-800',
  bakery_master:   'bg-sky-100 text-sky-800',
  cake_master:     'bg-fuchsia-100 text-fuchsia-800',
