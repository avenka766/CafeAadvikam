...
export const HOSUR_VRSNB_PRICE_LIST: HosurImportedShop[] = [
  { shopName: 'Shree Skanda Villas', whatsappNumber: '9626289603', items: [
    { itemName: 'Veg Puff', unitPrice: 17 },
    { itemName: 'Egg Puff (Full)', unitPrice: 30 },
  ] },
  { shopName: 'Lakshmi Foods', whatsappNumber: '9342331261', items: [
    { itemName: 'Veg Puff', unitPrice: 17 },
  ...
  { shopName: 'Vijay Lakshmi (Cam Soori Tea Kadai)', whatsappNumber: '9585494158', items: [
  ...
  { shopName: 'Grand Homes Made', whatsappNumber: '9500010364', items: [
  ...
  { shopName: 'Karupatti House (Fairmart Esta Pvt Ltd)', whatsappNumber: '9443669155', items: [
    { itemName: 'Bread', unitPrice: 35 },
    { itemName: 'Baby Bun', unitPrice: 30 },
    { itemName: 'Spl Bun', unitPrice: 10 },
  ] },
  { shopName: 'My Coffee Tea Shop', whatsappNumber: '6369390526', items: [
    { itemName: 'Bun', unitPrice: 5 },
  ] },
  { shopName: 'Tanishq', whatsappNumber: '9551230001', items: [
    { itemName: 'Cake (Kgs)', unitPrice: 650 },
  ] },
  { shopName: 'Uno Mindo', whatsappNumber: '7904379997', items: [
    { itemName: 'Bun', unitPrice: 4 },
    { itemName: 'Pav Bun', unitPrice: 4 },
    { itemName: 'Bread', unitPrice: 38 },
  ] },
  { shopName: 'Aavin Milk Shop', whatsappNumber: '9842070888', items: [
    { itemName: 'Bread', unitPrice: 35 },
  ] },
  { shopName: 'Sai Suprabaatham', whatsappNumber: '8760862928', items: [
    { itemName: 'Bread', unitPrice: 38 },
    { itemName: 'Bun', unitPrice: 4 },
  ...
  { shopName: 'VL Cafe Private Ltd', whatsappNumber: '9488802577', items: [
    { itemName: 'Veg Puff', unitPrice: 17 },
    { itemName: 'Egg Puff', unitPrice: 23 },
    { itemName: 'Cova Bun', unitPrice: 40 },
    { itemName: 'Black Forest', unitPrice: 45 },
  ...
  { shopName: 'Tamil Panipuri', whatsappNumber: '9500897206', items: [
    { itemName: 'Samosa', unitPrice: 15 },
  ] },
  { shopName: 'Anjana Super Market', whatsappNumber: '9629649663', items: [
    { itemName: 'Bread', unitPrice: 35 },
    { itemName: 'Wheat Bread', unitPrice: 35 },
    { itemName: 'Spl Bun', unitPrice: 10 },
    { itemName: 'Rusk (Pkt)', unitPrice: 55 },
  ] },
  { shopName: 'Rotary Club Of Sipcot', whatsappNumber: '9043030922', items: [
    { itemName: 'Birthday Prime Cake', unitPrice: 750 },
  ] },
  { shopName: 'Rotary Club Of Midtown', whatsappNumber: '8825400625', items: [
    { itemName: 'Birthday Prime Cake', unitPrice: 750 },
  ] },
  { shopName: 'Rotary Club Of Hosur', whatsappNumber: '8012580848', items: [
    { itemName: 'Birthday Prime Cake', unitPrice: 750 },
  ] },
];
