...
function NotificationCard({ n, onRead }: {
  n: { id: string; type?: string; title: string; body: string; isRead: boolean; createdAt: string; meta?: Record<string, unknown> };
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-body font-bold text-foreground">Packing Alerts</p>
                {unreadCount > 0 && (
            ...
            <div className={cn('flex items-start gap-2 px-3.5 py-2.5 rounded-xl border', meta.pill)}>
              ...
              <p className={cn('text-[11px] font-body leading-relaxed', meta.pillText)}>
                You are notified whenever packing dispatches <strong>fewer</strong> or <strong>more</strong> items than requested for <strong>{branch}</strong>, or when items have leftover grams kept at the bakery.
              </p>
            </div>
            ...
            {branchNotifications.length === 0 ? (
              <div className="flex flex-col items-center py-16 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">No packing alerts for {branch} yet.</p>
              </div>
            ) : (
